...
Console.WriteLine($"\n{minSum+1}-я строкa с наименьшей суммой ({sum}) элементов ");
...
int m = SetNumbers("Введите число строк 1-й матрицы: ");
int n = SetNumbers("Введите число столбцов 1-й и строк 2-й матриц: ");
int p = SetNumbers("Введите число столбцов 2-й матрицы: ");
int range = SetNumbers("Введите случайные числа от 1 до ");
